				...
				<div class="col-sm-9">
					<div class="beta-products-list">
						...
						<div class="beta-products-details">
							<p style="font-weight: bold ;font-size: 15px ; color: indigo" class="pull-left">{{count($sp_theoloai)}} styles found</p>
							<div class="clearfix"></div>
						</div>
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="#"><img src="source/image/product/{{$sp->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
										<p style="font-weight: bold ;font-size: 18px" class="single-item-title">{{$sp->name}}</p>
										...
										@else
										<span style="color:orangered">{{number_format($sp->unit_price)}} đồng</span>
										@endif
										</p>
									</div>
					...
					<div class="beta-products-list">
						<h4 style="font-weight: bold; color: green">Sản phẩm khác</h4>
						<div class="beta-products-details">
							<p style="font-weight: bold ;font-size: 15px ; color: indigo" class="pull-left">Tìm thấy {{count($sp_khac)}} sản phẩm</p>
							<div class="clearfix"></div>
						</div>
						<div class="row">
						@foreach($sp_khac as $sp_k)
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-body">
										<p style="font-weight: bold ;font-size: 18px"class="single-item-title">{{$sp_k->name}}</p>
										<p class="single-item-price" style="font-size: 18px">
										@if($sp_k->promotion_price !=0)
